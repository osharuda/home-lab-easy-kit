...
typedef struct __attribute__ ((aligned)) tag_AD9850DevPrivData {
    /// \brief THe last command sent to AD9850. It may be read from virtual device.
    AD9850Command command;
} AD9850DevPrivData;
typedef volatile AD9850DevPrivData* PAD9850DevPrivData;

/// \struct tag_AD9850DevInstance
/// \brief Structure that describes AD9850Dev virtual device
typedef struct __attribute__ ((aligned)) tag_AD9850DevInstance {
        ///< Virtual device context
        volatile DeviceContext      dev_ctx __attribute__ ((aligned));

        ///< Private data used by this AD9850Dev device
        volatile AD9850DevPrivData   privdata;
...
typedef volatile AD9850DevInstance* PAD9850DevInstance;
