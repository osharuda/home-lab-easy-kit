...
#include <cstddef>
#include <cstdint>
#include <libhlek/{devname}_common.hpp>

/// \addtogroup group_{devname}
/// @{{

/// \def Macro that indicates {DEVNAME} is being used and all variables may be linked to.
...
namespace {__NAMESPACE_NAME__} {{
    constexpr size_t {__{DEVNAME}_CONFIGURATION_ARRAY_NAME__}_number = {__{DEVNAME}_DEVICE_COUNT__};
    extern const {DevName}Config {__{DEVNAME}_CONFIGURATION_ARRAY_NAME__}[];

{__{DEVNAME}_CONFIGURATION_DECLARATIONS__}
