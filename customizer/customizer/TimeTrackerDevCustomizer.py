...
class TimeTrackerDevCustomizer(DeviceCustomizer):
    ...
    def customize(self):
        ...
        for dev_name, dev_config in self.device_list:
            ...
            fw_device_descriptors.append(f"""{{ {self.device_context_initializer}, {self.circular_buffer_initializer}, {{ {{0}} }}, {exti_pin_descr}, {near_full_pin_descr}, {fw_buffer_name}, {buffer_size}, {exti_control_reg}, {dev_id}, {exti_raise}, {exti_fall} }}""")
