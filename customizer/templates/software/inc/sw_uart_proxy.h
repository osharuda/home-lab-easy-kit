...
/// \struct tag_UartProxyDevInstance
/// \brief Descriptor for UART proxy virtual device.
typedef struct tag_UartProxyDevInstance {{
...
/// \def UART_PROXY_DESCRIPTOR
/// \brief Describes all UART proxy devices.
#define UART_PROXY_DESCRIPTOR {{ {__UART_SW_PROXY_DEV_DESCRIPTOR__} }}
