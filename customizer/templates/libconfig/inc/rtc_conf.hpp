...
/*!  \file
 *   \brief Generated include header of software part for RTC (Real Time Clock) device
 *   \author Oleh Sharuda
...
#include <cstddef>
#include <cstdint>
#include <libhlek/rtc_common.hpp>


/// \addtogroup group_rtc_dev
/// @{{

/// \def Macro that indicates RTC is being used and all variables may be linked to.
