...
/*!  \file
 *   \brief Generated include header of software part for IRRC (Infra Red Remote Control) device
 *   \author Oleh Sharuda
...
#include <cstddef>
#include <cstdint>
#include <libhlek/irrc_common.hpp>

/// \def Macro that indicates IRRC is being used and all variables may be linked to.
