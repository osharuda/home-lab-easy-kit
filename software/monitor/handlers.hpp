...
*/
    ...
    DEFINE_HANDLER_CLASS(SPIDACUploadPosSawWaveform);
    DEFINE_HANDLER_CLASS(SPIDACUploadNegSawWaveform);
    DEFINE_HANDLER_CLASS(SPIDACUploadGaussWaveform);
    DEFINE_HANDLER_CLASS(SPIDACUploadTriangleWaveform);
    DEFINE_HANDLER_CLASS(SPIDACUploadConstWaveform);


// -> ADD_DEVICE | HASH: 18812534EC04D74C570D3CB18C756C595E8A3613
	DEFINE_HANDLER_CLASS(PaceMakerDevInfoHandler);
    DEFINE_HANDLER_CLASS(PaceMakerDevStartHandler);
    DEFINE_HANDLER_CLASS(PaceMakerDevStopHandler);
    DEFINE_HANDLER_CLASS(PaceMakerDevResetHandler);
    DEFINE_HANDLER_CLASS(PaceMakerDevSetDataHandler);
// -> ADD_DEVICE | HASH: 18812534EC04D74C570D3CB18C756C595E8A3613
// -> ADD_DEVICE | HASH: 18812534EC04D74C570D3CB18C756C595E8A3613
