...
namespace tools {
	...
	static GlobalMutexVerifier g_mtx_verif;
    ...
    /// \param s - timer period in seconds
	...
	int stm32_timer_params(uint32_t freq, double s, uint16_t& prescaller, uint16_t& period, double& eff_s);
}
